          ...
          <CardContent className="p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-300">
                Siz allaqachon Backend testini topshirgansiz. Har bir foydalanuvchi faqat bir marta test topshirishi
                mumkin.
              </p>
            </div>
            <Button
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">Backend Bilim Testi</h1>
          <p className="text-gray-300 text-lg">Backend dasturlash tilidan bilimingizni sinab ko'ring</p>
        </div>
